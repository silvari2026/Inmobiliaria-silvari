...
var propiedades = [
    ...
    // ALQUILER DE CASAS
    {
        ...
        descripcion: 'Moderno apartamento con vista panoramica al mar Caribe. Totalmente equipado, con acabados de primera calidad.',
        latitud: 22.1156,
        longitud: -80.4510
    },
    {
    ...
    {
        id: 7,
        titulo: 'Casa de Playa Rancho Luna',
        ubicacion: 'Rancho Luna, Cienfuegos',
        precio: 1200,
        precioMostrar: '$1,200 USD / mes',
        tipo: 'alquiler',
        habitaciones: 4,
        banos: 3,
        metros: 200,
        ...
        descripcion: 'Hermosa casa frente a la playa en Rancho Luna. Perfecta para disfrutar del mar Caribe. Terraza con vista al mar y acceso directo a la playa.',
        latitud: 22.0987,
        longitud: -80.4345
    },
    ...
    {
        id: 8,
        titulo: 'Habitacion en Punta Gorda',
        ubicacion: 'Punta Gorda, Cienfuegos',
        precio: 150,
        precioMostrar: '$150 USD / mes',
        tipo: 'habitacion',
        habitaciones: 1,
        banos: 1,
        metros: 25,
        ...
        descripcion: 'Habitacion amplia y luminosa en casa colonial. Acceso a areas comunes: cocina, sala y terraza. Ideal para profesionales o estudiantes.',
        latitud: 22.1132,
        longitud: -80.4532
    },
    {
        id: 9,
        titulo: 'Habitacion Centro Cienfuegos',
        ubicacion: 'Centro, Cienfuegos',
        precio: 100,
        precioMostrar: '$100 USD / mes',
        tipo: 'habitacion',
        habitaciones: 1,
        banos: 1,
        metros: 20,
        ...
        descripcion: 'Habitacion comoda en el centro de la ciudad. Cerca de todos los servicios, transporte y lugares de interes.',
        latitud: 22.1190,
        longitud: -80.4498
    },
    {
        id: 10,
        titulo: 'Habitacion con Vista al Mar',
        ubicacion: 'Malecon, Cienfuegos',
        precio: 200,
        precioMostrar: '$200 USD / mes',
        tipo: 'habitacion',
        habitaciones: 1,
        banos: 1,
        metros: 30,
        ...
        descripcion: 'Habitacion con vista al mar en apartamento compartido. Cocina equipada, terraza y ambiente tranquilo.',
        latitud: 22.1156,
        longitud: -80.4510
    }
];
...
function obtenerEtiqueta(propiedad) {
    ...
    if (propiedad.tipo === 'habitacion') return { clase: 'habitacion', texto: 'Hab. en Alquiler' };
...
function filtrarPorCategoria(categoria) {
    ...
    for (var t = 0; t < tabs.length; t++) {
        tabs[t].classList.remove('activo');
    }
    
    var tabActivo;
    if (categoria === 'todas') tabActivo = tabs[0];
    else if (categoria === 'venta') tabActivo = tabs[1];
    else if (categoria === 'alquiler') tabActivo = tabs[2];
    else if (categoria === 'habitacion') tabActivo = tabs[3];
    ...
    if (categoria === 'todas') {
        ...
        for (var i = 0; i < propiedades.length; i++) {
            if (propiedades[i].tipo === 'venta') filtradas.push(propiedades[i]);
        }
        ...
        for (var i = 0; i < propiedades.length; i++) {
            if (propiedades[i].tipo === 'alquiler') filtradas.push(propiedades[i]);
        }
        ...
        for (var i = 0; i < propiedades.length; i++) {
            if (propiedades[i].tipo === 'habitacion') filtradas.push(propiedades[i]);
        }
